...
function context1(fun, obj, p1, p2){
  return fun.call(obj, p1, p2);
}
...
function sentenceMachine(partOne) {
	...
	return function sentenceSmasher(partTwo) {
		sentence.push(partTwo);
		console.log(partOne, sentence);
		return sentence.join('');
	};
}
var theTwoBecomeOne = sentenceMachine();
